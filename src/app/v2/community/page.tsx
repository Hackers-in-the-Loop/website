...
export const metadata = pageMetadata("Community / Connect", "Find your way into HITL, connect with Shannon, and read the community rules.", "/v2/community");
...
export default function CommunityPage() {
  return <>
    ...
    <section className="v2-connection" id="connect" aria-labelledby="connect-title"><div className="v2-wrap v2-section v2-split">
      <div><p className="v2-kicker">Our community home</p><h2 id="connect-title">Join the conversation on Discord.</h2><p>Share a build log, a question, a recent discovery, or an update from your life. Take an interest in what someone else is doing, too.</p>
        {siteConfig.discordUrl ? <div className="v2-actions"><a className="v2-button v2-button--primary" href={siteConfig.discordUrl} target="_blank" rel="noreferrer">Join Discord ↗</a></div> : <p className="v2-note">A public Discord invite is not published here yet. Contact Shannon on X or LinkedIn to ask about joining HITL.</p>}
      </div>
      <div className="v2-contact" id="founder-contact"><p className="v2-kicker">Founder / Connect</p><h3>Talk with Shannon Duncan.</h3><p>Ask about joining, share a project idea, or get in touch about the community.</p><FounderLinks /><a className="v2-link" href="/v2/why#founder">Meet Shannon →</a></div>
    </div></section>
    ...
    <section className="v2-wrap v2-section v2-split v2-rules" id="rules" aria-labelledby="rules-title"><div><p className="v2-kicker">How we treat one another</p><h2 id="rules-title">Community rules.</h2><p className="v2-note" style={{marginTop:"1rem"}}>Questions or concerns? <a className="v2-link" href="#founder-contact">Contact Shannon privately</a> through X or LinkedIn.</p></div><CommunityRules /></section>
  </>;
}
