...
export default function ProjectsPage() {
  return <>
    ...
    <div className="v2-wrap v2-project-choices">
      {[
        { href: "/projects/active", title: "Active projects", projects: labProjects, copy: "Experiments, research, and infrastructure work in progress." },
        { href: "/projects/completed", title: "Completed projects", projects: completedProjects, copy: "Finished builds and prototypes. Follow-on work can still continue." },
