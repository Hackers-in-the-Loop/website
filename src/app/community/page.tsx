  ...
  return <>
    ...
    <section className="site-shell community-section" id="join" aria-labelledby="connect-title">
      ...
      <div className="community-places">
        ...
        <article className="community-place"><p className="metadata">Founder / Joseph Duncan</p><h3>Connect with Joseph.</h3><p>Follow along on X, or get in touch there about the community, a project idea, or supporting the Lab with hardware or hosting.</p><div className="community-place__actions"><a className="button" href={siteConfig.xUrl} target="_blank" rel="noreferrer">Find Joseph on X ↗</a></div></article>
      </div>
    </section>
