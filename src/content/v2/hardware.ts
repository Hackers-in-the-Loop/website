export const hardware = [
  ...
  ["GPU bench", "15 cards. One dock.", "8 P100s, 2 V100s, 2 BC-160s, and 2 Radeon VIIs, including ten spares, plus one newly acquired NVIDIA P4 8 GB with installation unconfirmed. The K15 connects to a DEG2 dock with a 2 TB NVMe drive. Only one GPU is installed in the dock at a time."],
